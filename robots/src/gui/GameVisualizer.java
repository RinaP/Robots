...
public class GameVisualizer extends JPanel implements Observer
{
    ...
    public void CurrentConditionsDisplay(Robot robotData)
    {
        this.robotData = robotData;
        robotData.registerObserver(this);
    }
    
    public void update(double m_robotPosX, double m_robotPosY, double m_robotDirect, int m_targetPosX, int m_targetPosY) {
        m_robotPositionX = m_robotPosX;
        m_robotPositionY = m_robotPosY;
        m_robotDirection = m_robotDirect;
        m_targetPositionX = m_targetPosX;
        m_targetPositionY = m_targetPosY;
    }
